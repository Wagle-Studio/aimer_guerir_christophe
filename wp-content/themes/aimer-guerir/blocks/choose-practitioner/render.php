...
$main_title_raw   = get_theme_mod('aimer_guerir_choose_practitioner_main_title', '');
$main_content_raw = get_theme_mod('aimer_guerir_choose_practitioner_main_content', '');
$second_title_raw = get_theme_mod('aimer_guerir_choose_practitioner_second_title', '');
$second_content_raw = get_theme_mod('aimer_guerir_choose_practitioner_second_list', '');
...
<section class="choose-practitioner">
    <div class="choose-practitioner__wrapper">
        ...
        <div class="choose-practitioner__main">
            ...
            <h3 class="choose-practitioner__second-title"><?php echo esc_html($second_title); ?></h3>
