...
$third_hook_raw     = get_theme_mod('aimer_guerir_therapeutic_support_third_hook', '');

$image_id_main      = (int) get_theme_mod('aimer_guerir_therapeutic_support_image_id_main', 0);
$image_id_second    = (int) get_theme_mod('aimer_guerir_therapeutic_support_image_id_second', 0);
