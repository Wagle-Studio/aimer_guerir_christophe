...
$title_raw        = get_theme_mod('aimer_guerir_hero_title', '');
$sub_title_raw    = get_theme_mod('aimer_guerir_hero_sub_title', '');
$introduction_raw = get_theme_mod('aimer_guerir_hero_introduction', '');
$image_id         = (int) get_theme_mod('aimer_guerir_hero_image_id', 0);
$primary_label    = get_theme_mod('aimer_guerir_hero_primary_label', '');
$primary_url      = get_theme_mod('aimer_guerir_hero_primary_url', '');
$secondary_label  = get_theme_mod('aimer_guerir_hero_secondary_label', '');
$secondary_url    = get_theme_mod('aimer_guerir_hero_secondary_url', '');
	...
	<div class="hero__wrapper">
		<div class="hero__content">
			<div class="hero__header">
				...
				<p class="hero__subtitle"><?php echo wp_kses_post($sub_title_raw); ?></p>
			</div>
