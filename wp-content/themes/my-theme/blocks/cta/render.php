...
$title_raw   = get_theme_mod('my_theme_cta_title', '');
$subtitle_raw = get_theme_mod('my_theme_cta_subtitle', '');
$label_raw   = get_theme_mod('my_theme_cta_primary_label', '');
$url_raw     = get_theme_mod('my_theme_cta_primary_url', '');
...
<section class="cta">
    <div class="cta__wrapper">
        ...
        <a class="cta__btn btn btn--secondary btn--icon" href="<?php echo $url; ?>">
