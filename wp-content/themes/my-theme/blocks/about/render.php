...
$title_raw                = get_theme_mod('my_theme_about_title', '');
$subtitle_raw             = get_theme_mod('my_theme_about_subtitle', '');
$presentation_raw         = get_theme_mod('my_theme_about_presentation', '');
$primary_label            = get_theme_mod('my_theme_about_primary_label', '');
$primary_url              = get_theme_mod('my_theme_about_primary_url', '');
$sub_part_title_raw       = get_theme_mod('my_theme_about_sub_part_title', '');
$sub_part_description_raw = get_theme_mod('my_theme_about_sub_part_description', '');
$secondary_label          = get_theme_mod('my_theme_about_secondary_label', '');
$secondary_url            = get_theme_mod('my_theme_about_secondary_url', '');
$image_id                 = (int) get_theme_mod('my_theme_about_image_id', 0);
